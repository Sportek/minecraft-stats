...
/**
 * Infers a server's likely website from its address by stripping gaming
 * subdomains: `play.hypixel.net` -> `hypixel.net`.
 *
 * Returns `null` when we can't be sure (IP address, localhost, hostname without
 * a valid TLD): when in doubt, store/show nothing.
 */
