...
export default await Env.create(new URL('../', import.meta.url), {
  ...
  */
  ...
  /*
  |----------------------------------------------------------
  | Variables for configuring the drive (file storage) package
  |----------------------------------------------------------
  | DRIVE_DISK selects the active disk (`fs` in dev, `s3` in prod).
  | The AWS and S3 vars are only required when DRIVE_DISK=s3.
  */
