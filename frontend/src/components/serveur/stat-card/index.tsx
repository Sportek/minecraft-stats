...
const StatCard = ({ title, value, icon }: StatCardProps) => {
  return (
    <div className="group relative overflow-hidden rounded-lg border border-border bg-card text-card-foreground p-4 shadow-sm transition-all hover:border-accent/40 hover:shadow-md">
