...
interface AuthCardProps {
  /** Accent-tinted icon tile rendered in the card header. */
  icon: ReactNode;
  title: string;
  subtitle: string;
  children: ReactNode;
...
/**
 * Shared shell for the authentication screens: a centered card with an
 * accent icon tile, a bold title and a muted subtitle, followed by the body.
 */
