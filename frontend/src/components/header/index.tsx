...
import { getClientBackendUrl, resolveAvatarUrl } from "@/lib/domain";
    ...
    <DropdownMenu>
      ...
      >
        <Avatar className="h-9 w-9">
          <AvatarImage src={resolveAvatarUrl(user?.avatarUrl, user?.updatedAt)} alt={user?.username ?? "User Avatar"} />
          <AvatarFallback
                ...
                <div className="space-y-1">
                  ...
                  <div className="mb-2 flex items-center gap-3 rounded-lg border border-border bg-card p-3">
                    <Avatar className="h-10 w-10">
                      <AvatarImage src={resolveAvatarUrl(user.avatarUrl, user.updatedAt)} alt={user.username} />
                      <AvatarFallback
                        className="text-white text-sm"
                        style={{ background: letterTileGradient(user.username) }}
                      >
