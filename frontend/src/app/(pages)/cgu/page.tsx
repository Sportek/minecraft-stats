  ...
  return (
    <div className="mx-auto max-w-3xl space-y-8 py-8">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Dernière mise à jour : 2 Juin 2024 16h00</p>
      </div>

      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">1. Informations légales</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">2. Objet</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">3. Inscription et Compte Utilisateur</h2>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">4. Collecte et Traitement des Données Personnelles</h2>
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Types de Données Collectées</h3>
        <p>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Utilisation des Données</h3>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Cookies et Local Storage</h3>
        <p>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Stockage et Sécurité des Données</h3>
        <p>Les données collectées sont stockées sur un VPS de Pulseheberg situé en France.</p>
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Droits des Utilisateurs</h3>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Absence de DPO</h3>
        <p>Aucun Data Protection Officer (DPO) n&apos;a été nommé.</p>
      </section>

      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">5. Propriété Intellectuelle</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">6. Obligations et Responsabilités des Utilisateurs</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">7. Limitation de Responsabilité</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">8. Juridiction et Droit Applicable</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">9. Modification des CGU</h2>
        <p>
      ...
      <section className="rounded-lg border border-border bg-card p-6 text-card-foreground shadow-xs">
        <h2 className="mb-3 text-xl font-semibold tracking-tight text-foreground">Politique de Confidentialité (Annexe aux CGU)</h2>
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Collecte des Données</h3>
        <p>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Usage des Données</h3>
        <p>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Sécurité des Données</h3>
        <p>
        ...
        <h3 className="mb-1 mt-4 text-base font-semibold text-foreground">Durée de Conservation des Données</h3>
        <p>
